...
/* Core */
$string['title_page'] = 'Maycope: language workshop';
...
$string['marketing1content'] = '<p>Maycope is a company specialized in teaching Spanish and Danish.</p>';
$string['marketing1contentdesc'] = 'Content to display in the marketing box. Keep it short and sweet.';
$string['marketing1buttontext'] = 'Read more';
