...
<head>
    ...
    <meta name="description" content="<?php echo get_string('metadescription_gen','theme_essential')?>"/>
    <meta name="keywords" content="<?php echo get_string('metakeywords_gen','theme_essential')?>"/>
