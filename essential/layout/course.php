...
<head>
    ...
    <meta name="description" content="<?php echo get_string('metadescription_co','theme_essential')?>"/>
    <meta name="keywords" content="<?php echo get_string('metakeywords_co','theme_essential')?>"/>
    <!-- Google web fonts -->
